      ...
      <nav id="navbar" className="navbar order-last order-lg-0">
        <ul>
          ...
          {role !== "admin" && role !== "staff" && (
            <li>
              <NavLink
                to={token ? "/reservation" : "/login"}
                className={({ isActive }) =>
                  isActive && token ? "nav-link scrollto active" : ""
                }
              >
                Reservation
              </NavLink>
          ...
          {role !== "admin" && role !== "staff" && (
            <li className="cart-icon">
              <div className="navbar-search-icon">
                <NavLink
                  to={getTotalCartAmount() === 0 ? "/menu" : "/cart"}
                  className={({ isActive }) =>
          ...
          <ul>
            ...
            {role !== "admin" && role !== "staff" && (
              <li>
                <NavLink to={"/services"} activeClassName="active">
                  <FaWrench className="icon" /> <span>Services</span>
                </NavLink>
              </li>
            )}
            ...
            {role !== "admin" && role !== "staff" && (
              <li>
                <NavLink to={"/menu"} activeClassName="active">
                  <FaUtensils className="icon" /> <span>Menu</span>
                </NavLink>
              </li>
            )}
            ...
            {role !== "admin" && role !== "staff" && (
              <li>
                ...
                >
                  <FaStore className="icon" /> <span>Reservation</span>
                </NavLink>
              </li>
            )}
